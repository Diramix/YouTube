![YouTube Theme](https://github.com/user-attachments/assets/3f9a1d8d-79f6-484c-aee4-276a9c796ae0)
...
2. Теперь качаем [тему](https://github.com/Diramix/YouTube/releases).
...
4. Выберете тему в приложении мода И СТАВИТЕ ОБЯЗАТЕЛЬНО ТЁМНУЮ ТЕМУ В ЯНДЕКС МУЗЫКЕ.
5. Всё!
